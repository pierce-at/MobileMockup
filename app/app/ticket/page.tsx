    ...
    <section className="space-y-6">
      ...
      <div className="grid gap-4 xl:grid-cols-[1fr,0.92fr]">
        <article className="rounded-[14px] border border-midnight/8 bg-white p-5 shadow-card">
          ...
          <div className="mt-4 rounded-[10px] bg-mist px-4 py-4 text-sm text-midnight/72">
            <p className="font-semibold text-midnight">
              {ticketing.isConfigured ? "Eventbrite link configured" : "Eventbrite link still needs setup"}
            </p>
            <p className="mt-1">
              {ticketing.isConfigured
                ? ticketing.eventUrl
                : `Set NEXT_PUBLIC_EVENTBRITE_EVENT_URL. Support contact: ${ticketing.supportEmail}.`}
            </p>
          </div>
          <a
            href={ticketing.eventUrl ?? "https://www.eventbrite.com/"}
            target="_blank"
            rel="noreferrer"
        ...
        <article className="rounded-[14px] border border-midnight/8 bg-white p-5 shadow-card">
          ...
          <div className="mt-4 grid gap-3 text-sm leading-6 text-midnight/72">
            ...
            <p>Keep QR and badge sync outside MVP unless scope changes.</p>
          </div>
        </article>
      </div>
    </section>
